        ...
        <form action="" method="POST" onsubmit="event.preventDefault();" id="formUser">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 form-group">
                    ...
                    <input type="text" class="form-control" id="inputSurname" required name="surname" value="<?php echo $currUser->surname ?>" placeholder="Surname">
                </div>
                <div class="col-md-6 col-sm-12 form-group">
...
<script type="text/javascript">
    ...
    function updateProfile() {
        ...
        if (surname === '') {
            toastr.error('Enter the surname')
            inputSurname.focus()
            return
        }
        if (firstName === '') {
